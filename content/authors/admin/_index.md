...
name_pronunciation: Meow (as in the sound a cat makes) You
...
organizations:
  - name: The University of Hong Kong
    url: https://www.hkubs.hku.hk/people/miao-yu/

# Social network links
# Need to use another icon? Simply download the SVG icon to your `assets/media/icons/` folder.
profiles:
  - icon: at-symbol
    url: 'mailto: miaoyu@connect.hku.hk'
    label: E-mail Me
  - icon: brands/x
  ...
  - icon: brands/linkedin
    url: https://www.linkedin.com/in/miao-y-86a492118/
  - icon: academicons/google-scholar
    url: https://scholar.google.com/citations?user=Psa2zHcAAAAJ&hl=en
